...
/**
 * Test case for class S3b0\ProjectRegistration\Controller\ProjectController.
 *
...
class ProjectControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \S3b0\ProjectRegistration\Controller\ProjectController
	 */
	protected $subject = NULL;

	public function setUp() {
		$this->subject = $this->getMock('S3b0\\ProjectRegistration\\Controller\\ProjectController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllProjectsFromRepositoryAndAssignsThemToView() {
		...
		$projectRepository = $this->getMock('S3b0\\ProjectRegistration\\Domain\\Repository\\ProjectRepository', array('findAll'), array(), '', FALSE);
	...
	public function showActionAssignsTheGivenProjectToView() {
		$project = new \S3b0\ProjectRegistration\Domain\Model\Project();
	...
	public function createActionAddsTheGivenProjectToProjectRepository() {
		...
		$projectRepository = $this->getMock('S3b0\\ProjectRegistration\\Domain\\Repository\\ProjectRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenProjectInProjectRepository() {
		...
		$projectRepository = $this->getMock('S3b0\\ProjectRegistration\\Domain\\Repository\\ProjectRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenProjectFromProjectRepository() {
		...
		$projectRepository = $this->getMock('S3b0\\ProjectRegistration\\Domain\\Repository\\ProjectRepository', array('remove'), array(), '', FALSE);
